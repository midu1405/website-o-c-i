...
?>
<form action="modules/image/xuly.php?id=<?php echo $_GET['id']?>" method="POST" enctype="multipart/form-data">
<div style="width:400px; float:left;font-size:15px; padding-left:30px;">
<table width="500px" border="0px">
	<tr height="30" style="font-weight:bold;"> 
    	<td colspan="5" align="center"> CHỨC NĂNG SỬA ẢNH</td>
    </tr>
    <tr>
    	<td>
        	Tên ảnh:
        ...
        <td>
        	<input type="text" name="tenimage" value="<?php echo $dong['ten'];?>">
        </td>
    </tr>
    <tr>
    	<td>
    ...
    <tr>
    	<td>&nbsp; </td>
    	<td colspan="4">
        	<input type="submit" name="suaimage" value="Sửa ảnh" />
        </td>
    </tr>
</table>
</div>

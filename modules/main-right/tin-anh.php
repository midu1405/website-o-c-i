...
?>
<div class="box" style="border:none; height:200px; padding-top:20px;">
<p class="title" style="font-weight:bold"> ALBUM ẢNH</p>
<script type="text/javascript" src="jquery-slider-master/js/jquery-1.9.1.min.js"></script>
	...
	<script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (bodyWidth)
                    jssor_slider1.$SetScaleWidth(Math.min(bodyWidth, 945));
                else
	...
	<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1000px; height: 230px; overflow: hidden;">
		<div u="loading" style="position: absolute; top: 0px; left: 0px;">
		 ...
		 <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 250px; overflow: hidden;">
			<?php $sql="select * from album";
				include("admincp/modules/connect.php");
				$album=mysql_query($sql);
				//$dong=mysql_fetch_array($album);
				mysql_query("SET NAMES utf8");?>
				<?php
				
				while($dong=mysql_fetch_array($album)){?>
				<div><a u=image href="index.php?xem=album&image=<? echo $dong['idimage'];?>&album=<? echo $dong['idalbum']; ?>"><img u="image" src="<?php echo $dong['anhminhhoa'];?>" title="<? echo $dong['tenalbum'];?>" /> </a></div>
			<?php 
			}
			?>
		</div>

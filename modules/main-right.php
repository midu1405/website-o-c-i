<div class="main-right">
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider2.$SetScaleWidth(Math.min(parentWidth, 944));
                else
    ...
    <div id="slider2_container" style="position: relative; width: 944px;
        height: 500px;">
        ...
        <!-- Slides Ảnh -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 944px; height: 500px;
            overflow: hidden;">
			<?php 
			...
			<?php
				...
				<div><a u=image href="../aocuoi/index.php"><img src="<?php echo $dong['anhminhhoa'];?>"/></a></div>
			<?php 
			}
			?>
        </div>
	...
	<?php
		...
		{
			if ($_GET['xem']=='tintuc'){
				include("modules/main-right/chi-tiet.php");	
			}
			elseif ($_GET['xem']=='loaitin'){
				include("modules/main-right/chi-tiet-loai-tin.php");
			}
			elseif ($_GET['xem']=='album'){
				include("modules/main-right/tinimage.php");
				//include("modules/trang.php");
			}
		}
			else{
				include("modules/main-right/tin-moi.php");	
			...
			//include("modules/main-right/tin-tuc.php");
	?>    
</div>